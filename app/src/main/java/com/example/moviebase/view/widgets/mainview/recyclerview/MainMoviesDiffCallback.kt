...
class MainMoviesDiffCallback : DiffUtil.ItemCallback<MovieEntryModel>() {
    ...
    override fun areContentsTheSame(oldItem: MovieEntryModel, newItem: MovieEntryModel): Boolean {
        return oldItem.id == newItem.id && oldItem.posterPath == newItem.posterPath
                ...
                && oldItem.voteCount == newItem.voteCount && oldItem.title == newItem.title && oldItem.type == newItem.type
    }
